...
The project is currently developed based on `"mapbox-gl": "1.13.3"`.
...
You can normally use "mapbox-gl": "1.13.3" version APIs for further map development. MxCAD's drawing and editing won't affect it since CAD drawings in MxCAD are always placed on a webgl layer provided by mapbox.
...
Finally, install the `mapbox-gl@1.13.3` dependency, and you can directly import it in ts files.
