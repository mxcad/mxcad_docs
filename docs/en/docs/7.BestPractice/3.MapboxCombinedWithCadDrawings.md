...
The **patches under the root directory of the demo source code must contain mapbox-gl patches**, and **mapbox-gl must be of 1.13.3**; otherwise, the patches cannot be used normally
