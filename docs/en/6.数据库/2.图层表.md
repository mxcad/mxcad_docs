...
Click on [the database layer table McDbLayerTable()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLayerTable.html), [the layer table record object McDbLayerTableRecord](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLayerTableRecord.html), [the database instance McDbDatabase()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbDatabase.html) to check the detailed description attributes and methods.
...
Click on [McDbDatabase getCurrentlyLayerId()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbDatabase.html#getcurrentlylayerid) View detailed property and method descriptions.
```ts
import { MxCpp} from "mxcad" 
...
Click [McObject addLayer()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#addlayer) to check the properties and methods in detail.
...
tap [MxCADSelectionSet](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#class-mxcadselectionset)  , [MxCADResbuf] (https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADResbuf.html#class-mxcadresbuf) to check the detailed description attributes and methods.
...
Click [McDbEntity layer](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEntity.html#layer) to check the properties and methods in detail.
