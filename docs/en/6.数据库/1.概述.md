...
![Database structure](../../assets/img/%E6%95%B0%E6%8D%AE%E5%BA%93%E7%BB%93%E6%9E%84.png)
...
* Symbol tables and dictionaries are container objects used to store database objects, both of which can map a symbol name to a database object. The database consists of a fixed number of symbol tables, each containing an instance of a particular class as a symbol table record. Examples of the symbol table as [data layer surface table](./2.%E5%9B%BE%E5%B1%82%E8%A1%A8.md) ([McDbLayerTable()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLayerTable.html), Layer contains table record) and [watch](./5.%E5%9D%97%E8%A1%A8.md) ([McDbBlockTable()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbBlockTable.html), which contains block table records), all entities belong to block table records.

* Dictionaries provide a more general container object for storing objects than symbol tables, A dictionary can contain any [McDbObject] (https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbObject.html#class-mcdbobject) or other subclass object.
