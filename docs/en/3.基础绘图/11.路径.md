...
Click on the [path path](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#pathlineto) , [drawPath rendering path](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#drawpathtopolyline) to check the detailed description attributes and methods.
