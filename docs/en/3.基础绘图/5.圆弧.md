...
Click [McDbArc()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbArc.html) to check the properties and methods in detail.

Click [drawArc()，drawArc2()，drawArc3()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#drawarc) to check the properties and methods in detail.
```ts
