...
Click [McDbEllipse()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEllipse.html) to check the properties and methods in detail.

Click [drawEllipse()、drawEllipseArc()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#drawellipse) to check the properties and methods in detail.
