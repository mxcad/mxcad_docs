...
We know through the [Quick Start](../1.指南/1.快速入门.md)  that if you open the drawing and want to perform various processing on the graph, you need a variety of calculations, mxcad provides some classes to participate in the calculation or represent some data structures.
...
![Describe vector mathematical operations](../../assets/img/描述向量数学运算.png)
...
![Vector addition](../../assets/img/向量相加.png)
...
![Vector subtraction](../../assets/img/向量相减.png)
...
![Vector dot product](../../assets/img/向量点乘.png)
...
![Vector cross product](../../assets/img/向量叉乘.png)
...
![Cross product determinant representation](../../assets/img/叉乘行列式表示.png)
...
![Matrix A](../../assets/img/矩阵A.png)

设列向量:
![Column vector](../../assets/img/列向量.png)

用列向量去右乘矩阵A
![The column vectors multiply to the right by the matrix A](../../assets/img/列向量去右乘矩阵A.png)

It's equivalent to taking A linear combination of the column vectors in matrix A

Multiply A matrix A by a column vector
![Column vector multiplied by matrix A](../../assets/img/列向量左乘矩阵A.png)
...
Set a matrix B:
![Matrix B](../../assets/img/矩阵B.png)

Multiply matrix A by matrix B:
![Let's multiply matrix B by matrix A](../../assets/img/矩阵B来左乘矩阵A.png)
...
![Calculating formula of arc crown](../../assets/img/圆弧凸度计算公式.png)
