...
This class provides a unified field access interface for writing or reading geometric and attribute data from custom entities into DWG files by name.
In custom entity development, it is usually necessary to implement:
-WritePoint/ReadPoint: Processing McGePoint3d type fields;
-WritePoints/readPoints: Processing point array fields;
-WriteLong/readLong: Processing integer values;
-WriteDouble/ReadDouble: Processing floating-point numbers;
-WriteString/readString: Processing strings.
