...
McDbDimension is the base class for dimension entity classes, used to uniformly manage the behavior of dimension objects.

**`Description`**

This class is used to represent dimension objects and provides general capabilities such as dimension styles, text, arrows, and measurement value associations.

Summary of usage:
1. First, initialize the dimension object through subclasses such as McDbAlignedDimension and McDbRotatedDimension.
2. Assign values to the size baseline point, size line point, and text position, and set the annotation style.
...
- [`McDbEntity`](2d.McDbEntity.md)
  ...
  ↳↳ [`McDbRadialDimension`](2d.McDbRadialDimension.md)

  ↳↳ [`McDbDiametricDimension`](2d.McDbDiametricDimension.md)
...
- [thickness](2d.McDbDimension.md#thickness)
...
- [getGripEditBasePointsIndex](2d.McDbDimension.md#getgripeditbasepointsindex)
