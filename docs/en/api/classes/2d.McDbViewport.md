[mxcad_2d API documentation] (../README. md)/[2d] (../modules/2d. md)/McDbViewport

# Class: McDbViewport

[2d](../modules/2d.md).McDbViewport

McDbViewport is a viewport object class used to create and manage layout viewports.

**`Description`**

This class is used to represent viewport objects in CAD and supports setting viewport size, center position, and display range.

Summary of usage:
1. First, create an instance of McDbViewport.
2. Set parameters such as width, height, and center position.
3. Finally, apply it to the layout viewport for display.
...
Obtain the center position of the viewport
...
Set the center position of the viewport
...
Obtain the rotation angle of the visible area
...
Set the rotation angle of the visible area
...
Obtain the visual position of the viewport
...
Set the visual position of the viewport
...
Obtain the target position of the viewport
