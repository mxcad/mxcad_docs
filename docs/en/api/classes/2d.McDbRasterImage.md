...
//Create a new instance of McDbRasterImage
...
console.log(clipBoundaryPoints); //  Output the set of points for cropping boundaries
```
...
console.log(type); //  Output the type of clipping boundary
```
...
Definition of Image Acquisition I
...
console.log(imageId.id); //  Definition ID of output image
```
...
```ts
//Assuming RasterImage is an instance of a raster image
const clipBoundaryType = McDb.ClipBoundaryType.kRectangular; //  For example, the cropping type is rectangular
const clipBoundaryPoints = new McGePoint3dArray(); //  Assuming that the points with cropped boundaries have already been filled
...
| Name | Type | Description |
| :------ | :------ | :------ |
|Type | [ClipBoundaryType] (../enums/2d. McDb. ClipBoundaryType. md) | Type of clipping boundary|
|AryPoint | [McGePoint3dArray] (2d. McGePoint3dArray. md) | Crop boundary point group|
