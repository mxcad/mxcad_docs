[mxcad_2d API documentation] (../README. md)/[2d] (../modules/2d. md)/McDbRasterImage

# Class: McDbRasterImage

[2d](../modules/2d.md).McDbRasterImage

McDbRasterImage is a raster image entity class used to display bitmap images in CAD.

**`Description`**

This class is used for inserting and managing raster image objects, and supports setting image definition IDs, display sizes, orientations, and cropping boundaries.

It is suitable for embedding external image resources in drawings and controlling the position, scaling, and cropping effects of images as needed.

Summary of usage:
1. First, create an instance of McDbRasterImage.
2. Set the image definition ID, display size, orientation, and cropping boundary again.
3. Finally, draw it into the current space.
...
Obtain the cropping boundary of the image object
...
Obtain the type of clipping boundary
...
Return the width, height, and pixels of the image in the DWG file.
...
Obtain the direction of the image

#### Returns

`Object`

origin:  Origin | uCorner: vector along the X-axis | vPnP lane: vector along the Y-axis
...
```ts
//Assuming RasterImage is an instance of a raster image
const orientation = rasterImage.getOrientation();
console.log(orientation.origin); //  Output origin point
console.log(orientation.uCorner); //  Output a vector along the X-axis
console.log(orientation.vOnPlane); //  Output a vector along the Y-axis
```
...
Obtain the definition ID of the image
...
Does the image use cutting boundaries
...
Set the image to use cutting boundaries
...
Set the cropping boundary of image objects

#### Parameters

| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `type` | [`ClipBoundaryType`](../enums/2d.McDb.ClipBoundaryType.md) | `undefined` |  Type of clipping boundary|
|AryPoint | [McGePoint3dArray] (2d. McGePoint3dArray. md) | undefined | Crop boundary point group|
...
Return a Boolean value indicating whether the setting was successful.
...
Set the width, height, and pixels of the image when saving DWG files.
...
Set the definition ID for the image

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
|ImageId | [McObject Id] (2d. McObject Id. md) | Definition ID of the image|
...
Set or retrieve the direction of the image

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
|Origin | [McGePoint3d] (2d. McGePoint3d. md) | Origin|
|UCorner | [McGeVector3d] (2d. McGeVector3d. md) | Vector along the X-axis|
|VPnP lane | [McGeVector3d] (2d. McGeVector3d. md) | Vector along the Y-axis|
