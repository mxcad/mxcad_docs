...
Representing a solid arc, used to draw partial circular curves.

**`Description`**

McDbArc encapsulates an arc object that supports setting the center, radius, start angle, and end angle, enabling the drawing and calculation of arc geometry.
It is suitable for drawing partial circles, creating arc objects, or performing arc calculations on graphics.
Instructions:
1. Create a McDbArc instance.
2. Set 'center', 'radius',' startAngle ', and' endAngle '.
3. Display the arc in the drawing context.
...
- [thickness](2d.McDbArc.md#thickness)
...
- [correctMirror](2d.McDbArc.md#correctmirror)
...
- [getGripEditBasePointsIndex](2d.McDbArc.md#getgripeditbasepointsindex)
...
Correct the arc directed by the mirror
