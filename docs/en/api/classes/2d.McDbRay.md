[mxcad_2d API documentation] (../README. md)/[2d] (../modules/2d. md)/McDbRay

# Class: McDbRay

[2d](../modules/2d.md).McDbRay

McDbRay is a ray object class used to create rays that extend from a base point in a specified direction.

**`Description`**

This class is used to represent a ray in CAD and is commonly used to assist in locating, measuring, and constructing geometric relationships.

Summary of usage:
1. First, create an instance of McDbRay.
2. Set its base point and direction vector again.
3. Finally, draw the ray into the current space.
...
- [constructor](2d.McDbRay.md#constructor)

### Properties

- [imp](2d.McDbRay.md#imp)

### Accessors

- [basePoint](2d.McDbRay.md#basepoint)
- [colorIndex](2d.McDbRay.md#colorindex)
- [drawOrder](2d.McDbRay.md#draworder)
- [dxf0](2d.McDbRay.md#dxf0)
- [layer](2d.McDbRay.md#layer)
- [layerId](2d.McDbRay.md#layerid)
- [linetype](2d.McDbRay.md#linetype)
- [linetypeId](2d.McDbRay.md#linetypeid)
- [linetypeScale](2d.McDbRay.md#linetypescale)
- [lineweight](2d.McDbRay.md#lineweight)
- [normal](2d.McDbRay.md#normal)
- [objectName](2d.McDbRay.md#objectname)
- [textStyle](2d.McDbRay.md#textstyle)
- [textStyleId](2d.McDbRay.md#textstyleid)
- [thickness](2d.McDbRay.md#thickness)
- [trueColor](2d.McDbRay.md#truecolor)
- [unitDir](2d.McDbRay.md#unitdir)
- [visible](2d.McDbRay.md#visible)

### Methods

- [IntersectWith](2d.McDbRay.md#intersectwith)
- [assertObjectModification](2d.McDbRay.md#assertobjectmodification)
- [clone](2d.McDbRay.md#clone)
- [createExtensionDictionary](2d.McDbRay.md#createextensiondictionary)
- [deleteXData](2d.McDbRay.md#deletexdata)
- [disableDisplay](2d.McDbRay.md#disabledisplay)
- [erase](2d.McDbRay.md#erase)
- [explode](2d.McDbRay.md#explode)
- [getAllAppName](2d.McDbRay.md#getallappname)
- [getArea](2d.McDbRay.md#getarea)
- [getBoundingBox](2d.McDbRay.md#getboundingbox)
- [getClosestPointTo](2d.McDbRay.md#getclosestpointto)
- [getDatabase](2d.McDbRay.md#getdatabase)
- [getDatabaseIndexId](2d.McDbRay.md#getdatabaseindexid)
- [getDistAtParam](2d.McDbRay.md#getdistatparam)
- [getDistAtPoint](2d.McDbRay.md#getdistatpoint)
- [getEndParam](2d.McDbRay.md#getendparam)
- [getEndPoint](2d.McDbRay.md#getendpoint)
- [getExtensionDictionary](2d.McDbRay.md#getextensiondictionary)
- [getFirstDeriv](2d.McDbRay.md#getfirstderiv)
- [getFirstDerivFromParam](2d.McDbRay.md#getfirstderivfromparam)
- [getGripEditBasePointsIndex](2d.McDbRay.md#getgripeditbasepointsindex)
- [getGripPoints](2d.McDbRay.md#getgrippoints)
- [getHandle](2d.McDbRay.md#gethandle)
- [getImp](2d.McDbRay.md#getimp)
- [getJson](2d.McDbRay.md#getjson)
- [getLength](2d.McDbRay.md#getlength)
- [getObjectID](2d.McDbRay.md#getobjectid)
- [getOwnerID](2d.McDbRay.md#getownerid)
- [getParamAtDist](2d.McDbRay.md#getparamatdist)
- [getParamAtPoint](2d.McDbRay.md#getparamatpoint)
- [getPointAtDist](2d.McDbRay.md#getpointatdist)
- [getPointAtParam](2d.McDbRay.md#getpointatparam)
- [getSamplePoints](2d.McDbRay.md#getsamplepoints)
- [getStartParam](2d.McDbRay.md#getstartparam)
- [getStartPoint](2d.McDbRay.md#getstartpoint)
- [getxData](2d.McDbRay.md#getxdata)
- [getxDataDouble](2d.McDbRay.md#getxdatadouble)
- [getxDataLong](2d.McDbRay.md#getxdatalong)
- [getxDataPoint](2d.McDbRay.md#getxdatapoint)
- [getxDataString](2d.McDbRay.md#getxdatastring)
- [highlight](2d.McDbRay.md#highlight)
- [initTempObject](2d.McDbRay.md#inittempobject)
- [isErased](2d.McDbRay.md#iserased)
- [isHaveExtensionDictionary](2d.McDbRay.md#ishaveextensiondictionary)
- [isKindOf](2d.McDbRay.md#iskindof)
- [isNull](2d.McDbRay.md#isnull)
- [mirror](2d.McDbRay.md#mirror)
- [move](2d.McDbRay.md#move)
- [moveGripPointsAt](2d.McDbRay.md#movegrippointsat)
- [offsetCurves](2d.McDbRay.md#offsetcurves)
- [rotate](2d.McDbRay.md#rotate)
- [scaleEntity](2d.McDbRay.md#scaleentity)
- [setBasePoint](2d.McDbRay.md#setbasepoint)
- [setJson](2d.McDbRay.md#setjson)
- [setUnitDir](2d.McDbRay.md#setunitdir)
- [setxData](2d.McDbRay.md#setxdata)
- [setxDataDouble](2d.McDbRay.md#setxdatadouble)
- [setxDataLong](2d.McDbRay.md#setxdatalong)
- [setxDataPoint](2d.McDbRay.md#setxdatapoint)
- [setxDataString](2d.McDbRay.md#setxdatastring)
- [splitCurves](2d.McDbRay.md#splitcurves)
- [splitCurvesFromParam](2d.McDbRay.md#splitcurvesfromparam)
- [syncData](2d.McDbRay.md#syncdata)
- [transformBy](2d.McDbRay.md#transformby)
- [unErase](2d.McDbRay.md#unerase)
- [updateDisplay](2d.McDbRay.md#updatedisplay)
