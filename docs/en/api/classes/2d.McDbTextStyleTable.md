...
This class is used to maintain and access a collection of text styles, supporting the viewing, creation, and name retrieval of text styles.
It can accomplish:
-Obtain all text style record IDs;
-Add new text styles;
-Search for the specified style by name;
-Determine whether the style exists;
-Subsequently, obtain the McDbTextCtyleTableRecord through the object ID for parameter setting.
