...
McDbWipeout is a Wipeout entity class used to create occluded area objects in drawings.

**`Description`**

This class is used to generate occluded objects, can be used to cover graphic display areas, and is commonly used to hide background or local area content.

Summary of usage:
1. First, create the McDbWipeout object.
2. Set its boundary vertices and occlusion areas again.
3. Finally, add it to the current space and display the occlusion effect.
...
- [thickness](2d.McDbWipeout.md#thickness)
...
- [getGripEditBasePointsIndex](2d.McDbWipeout.md#getgripeditbasepointsindex)
