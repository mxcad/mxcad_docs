[mxcad_2d API documentation] (../README. md)/[2d] (../modules/2d. md)/McDBMText

# Class: McDbMText

[2d](../modules/2d.md).McDbMText

McDbMText is a multiline text entity class used for creating and editing multiline text objects.

**`Description`**

This class is used to insert multiple lines of text in drawings and supports setting content, width, height, position, and text style.

Summary of usage:
1. First, create an instance of McDbMText.
2. Set layout parameters such as content, width, height, position, and attachment points.
...
const mText = new McDbMText();//  Construct a new multiline text object
mText.textHeight = 10;//  Set text height
mText.attachment = McDb.AttachmentPoint.kMiddleLeft;//  Set text alignment method
MText. contents='Control:\ \P Multi line Text '// Set text content
mText.location = new McGePoint3d(0,0,0); //  Set text position
MxCpp.getCurrentMxCAD().drawEntity(mText); //  Draw multiple lines of text
```
...
- [drawOrder](2d.McDbMText.md#draworder)
...
- [thickness](2d.McDbMText.md#thickness)
...
- [assertObjectModification](2d.McDbMText.md#assertobjectmodification)
- [clone](2d.McDbMText.md#clone)
- [createExtensionDictionary](2d.McDbMText.md#createextensiondictionary)
...
- [getDatabaseIndexId](2d.McDbMText.md#getdatabaseindexid)
- [getExtensionDictionary](2d.McDbMText.md#getextensiondictionary)
- [getGripEditBasePointsIndex](2d.McDbMText.md#getgripeditbasepointsindex)
- [getGripPoints](2d.McDbMText.md#getgrippoints)
...
- [getTextString](2d.McDbMText.md#gettextstring)
...
- [isHaveExtensionDictionary](2d.McDbMText.md#ishaveextensiondictionary)
- [isKindOf](2d.McDbMText.md#iskindof)
- [isNull](2d.McDbMText.md#isnull)
- [mirror](2d.McDbMText.md#mirror)
- [move](2d.McDbMText.md#move)
- [moveGripPointsAt](2d.McDbMText.md#movegrippointsat)
- [reCompute](2d.McDbMText.md#recompute)
...
- [syncData](2d.McDbMText.md#syncdata)
- [transformBy](2d.McDbMText.md#transformby)
- [unErase](2d.McDbMText.md#unerase)
- [updateDisplay](2d.McDbMText.md#updatedisplay)
...
| Name | Type | Description |
| :------ | :------ | :------ |
|Val | [AttachmentPoint] (../enums/2d. McDb. AttachmentPoint. md) | Attachment Point|
...
| Name | Type | Description |
| :------ | :------ | :------ |
|Pt | McGePoint3d (2d. McGePoint3d. md) | Position Point|
...
Retrieve content without formatting controls in the text

#### Returns

`string`

Content without format control symbols
...
Recalculate the display data of format control symbols for multi line text in multi line documents.
