...
McDbLine is a line entity class used to create and manage 2D or 3D line objects.

**`Description`**

This class is used to draw and edit line objects in drawings, and supports setting properties such as starting point, ending point, color, layer, and line type.

Summary of usage:
1. First, create an instance of McDbLine.
2. Assign values to the starting and ending points, and set display properties such as layer, color, and line type.
3. Finally, draw the object to the current space or insert it into the block definition.
...
- [thickness](2d.McDbLine.md#thickness)
...
- [getGripEditBasePointsIndex](2d.McDbLine.md#getgripeditbasepointsindex)
