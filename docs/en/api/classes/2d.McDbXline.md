[mxcad_2d API documentation] (../README. md)/[2d] (../modules/2d. md)/McDbXline

# Class: McDbXline

[2d](../modules/2d.md).McDbXline

McDbXline is a construction line object class used to create infinitely extending construction lines.

**`Description`**

This class is used to create a construction line in a drawing that extends infinitely in a specified direction from a base point, and is commonly used as an auxiliary drawing and positioning reference.

Summary of usage:
1. First, create an instance of McDbXline.
2. Set its base point and direction vector again.
3. Finally, draw the construction line into the current space.
...
- [constructor](2d.McDbXline.md#constructor)

### Properties

- [imp](2d.McDbXline.md#imp)

### Accessors

- [basePoint](2d.McDbXline.md#basepoint)
- [colorIndex](2d.McDbXline.md#colorindex)
- [drawOrder](2d.McDbXline.md#draworder)
- [dxf0](2d.McDbXline.md#dxf0)
- [layer](2d.McDbXline.md#layer)
- [layerId](2d.McDbXline.md#layerid)
- [linetype](2d.McDbXline.md#linetype)
- [linetypeId](2d.McDbXline.md#linetypeid)
- [linetypeScale](2d.McDbXline.md#linetypescale)
- [lineweight](2d.McDbXline.md#lineweight)
- [normal](2d.McDbXline.md#normal)
- [objectName](2d.McDbXline.md#objectname)
- [textStyle](2d.McDbXline.md#textstyle)
- [textStyleId](2d.McDbXline.md#textstyleid)
- [thickness](2d.McDbXline.md#thickness)
- [trueColor](2d.McDbXline.md#truecolor)
- [unitDir](2d.McDbXline.md#unitdir)
- [visible](2d.McDbXline.md#visible)

### Methods

- [IntersectWith](2d.McDbXline.md#intersectwith)
- [assertObjectModification](2d.McDbXline.md#assertobjectmodification)
- [clone](2d.McDbXline.md#clone)
- [createExtensionDictionary](2d.McDbXline.md#createextensiondictionary)
- [deleteXData](2d.McDbXline.md#deletexdata)
- [disableDisplay](2d.McDbXline.md#disabledisplay)
- [erase](2d.McDbXline.md#erase)
- [explode](2d.McDbXline.md#explode)
- [getAllAppName](2d.McDbXline.md#getallappname)
- [getArea](2d.McDbXline.md#getarea)
- [getBoundingBox](2d.McDbXline.md#getboundingbox)
- [getClosestPointTo](2d.McDbXline.md#getclosestpointto)
- [getDatabase](2d.McDbXline.md#getdatabase)
- [getDatabaseIndexId](2d.McDbXline.md#getdatabaseindexid)
- [getDistAtParam](2d.McDbXline.md#getdistatparam)
- [getDistAtPoint](2d.McDbXline.md#getdistatpoint)
- [getEndParam](2d.McDbXline.md#getendparam)
- [getEndPoint](2d.McDbXline.md#getendpoint)
- [getExtensionDictionary](2d.McDbXline.md#getextensiondictionary)
- [getFirstDeriv](2d.McDbXline.md#getfirstderiv)
- [getFirstDerivFromParam](2d.McDbXline.md#getfirstderivfromparam)
- [getGripEditBasePointsIndex](2d.McDbXline.md#getgripeditbasepointsindex)
- [getGripPoints](2d.McDbXline.md#getgrippoints)
- [getHandle](2d.McDbXline.md#gethandle)
- [getImp](2d.McDbXline.md#getimp)
- [getJson](2d.McDbXline.md#getjson)
- [getLength](2d.McDbXline.md#getlength)
- [getObjectID](2d.McDbXline.md#getobjectid)
- [getOwnerID](2d.McDbXline.md#getownerid)
- [getParamAtDist](2d.McDbXline.md#getparamatdist)
- [getParamAtPoint](2d.McDbXline.md#getparamatpoint)
- [getPointAtDist](2d.McDbXline.md#getpointatdist)
- [getPointAtParam](2d.McDbXline.md#getpointatparam)
- [getSamplePoints](2d.McDbXline.md#getsamplepoints)
- [getStartParam](2d.McDbXline.md#getstartparam)
- [getStartPoint](2d.McDbXline.md#getstartpoint)
- [getxData](2d.McDbXline.md#getxdata)
- [getxDataDouble](2d.McDbXline.md#getxdatadouble)
- [getxDataLong](2d.McDbXline.md#getxdatalong)
- [getxDataPoint](2d.McDbXline.md#getxdatapoint)
- [getxDataString](2d.McDbXline.md#getxdatastring)
- [highlight](2d.McDbXline.md#highlight)
- [initTempObject](2d.McDbXline.md#inittempobject)
- [isErased](2d.McDbXline.md#iserased)
- [isHaveExtensionDictionary](2d.McDbXline.md#ishaveextensiondictionary)
- [isKindOf](2d.McDbXline.md#iskindof)
- [isNull](2d.McDbXline.md#isnull)
- [mirror](2d.McDbXline.md#mirror)
- [move](2d.McDbXline.md#move)
- [moveGripPointsAt](2d.McDbXline.md#movegrippointsat)
- [offsetCurves](2d.McDbXline.md#offsetcurves)
- [rotate](2d.McDbXline.md#rotate)
- [scaleEntity](2d.McDbXline.md#scaleentity)
- [setBasePoint](2d.McDbXline.md#setbasepoint)
- [setJson](2d.McDbXline.md#setjson)
- [setUnitDir](2d.McDbXline.md#setunitdir)
- [setxData](2d.McDbXline.md#setxdata)
- [setxDataDouble](2d.McDbXline.md#setxdatadouble)
- [setxDataLong](2d.McDbXline.md#setxdatalong)
- [setxDataPoint](2d.McDbXline.md#setxdatapoint)
- [setxDataString](2d.McDbXline.md#setxdatastring)
- [splitCurves](2d.McDbXline.md#splitcurves)
- [splitCurvesFromParam](2d.McDbXline.md#splitcurvesfromparam)
- [syncData](2d.McDbXline.md#syncdata)
- [transformBy](2d.McDbXline.md#transformby)
- [unErase](2d.McDbXline.md#unerase)
- [updateDisplay](2d.McDbXline.md#updatedisplay)
...
• `get` **basePoint**(): [`McGePoint3d`](2d.McGePoint3d.md)
...
• `get` **unitDir**(): [`McGeVector3d`](2d.McGeVector3d.md)

Obtain the direction vector of the ray.

#### Returns

[`McGeVector3d`](2d.McGeVector3d.md)

• `set` **unitDir**(`vec`): `void`
