[mxcad_2d API documentation] (../README. md)/[2d] (../modules/2d. md)/McDDbSplit

# Class: McDbSpline

[2d](../modules/2d.md).McDbSpline

McDbSpline is a spline solid class used for creating and editing NURBS spline curves.

**`Description`**

This class is used to represent spline curve objects in CAD and supports setting data such as control points, nodes, weights, and fitting points.

It is suitable for constructing smooth and continuous curve shapes, and for reading and modifying spline data.

Summary of usage:
1. First, create an instance of McDDbSplit.
2. Set control points, nodes, weights, or fitting point data again.
3. Finally, draw the spline curve into the current space.
...
- [thickness](2d.McDbSpline.md#thickness)
...
- [getFirstDerivFromParam](2d.McDbSpline.md#getfirstderivfromparam)
- [getFitPoints](2d.McDbSpline.md#getfitpoints)
- [getGripEditBasePointsIndex](2d.McDbSpline.md#getgripeditbasepointsindex)
