[mxcad_2d API documentation] (../README. md)/[2d] (../modules/2d. md)/McDbContextEntity

# Class: McDbBackgroundEntity

[2d](../modules/2d.md).McDbBackgroundEntity

McDBackground Entity is a background drawing object class used to manage the display state of background graphics.

**`Description`**

This class is used to control the display and hiding of background objects, and can switch background content based on external DWG files.

Summary of usage:
1. First, create the McDBackground Entity object.
2. Bind the target DWG file again and set the display status.
3. Finally, control the presentation of background content through display or cleaning operations.
...
- [constructor](2d.McDbBackgroundEntity.md#constructor)

### Properties

- [imp](2d.McDbBackgroundEntity.md#imp)

### Accessors

- [colorIndex](2d.McDbBackgroundEntity.md#colorindex)
- [drawOrder](2d.McDbBackgroundEntity.md#draworder)
- [dxf0](2d.McDbBackgroundEntity.md#dxf0)
- [layer](2d.McDbBackgroundEntity.md#layer)
- [layerId](2d.McDbBackgroundEntity.md#layerid)
- [linetype](2d.McDbBackgroundEntity.md#linetype)
- [linetypeId](2d.McDbBackgroundEntity.md#linetypeid)
- [linetypeScale](2d.McDbBackgroundEntity.md#linetypescale)
- [lineweight](2d.McDbBackgroundEntity.md#lineweight)
- [normal](2d.McDbBackgroundEntity.md#normal)
- [objectName](2d.McDbBackgroundEntity.md#objectname)
- [textStyle](2d.McDbBackgroundEntity.md#textstyle)
- [textStyleId](2d.McDbBackgroundEntity.md#textstyleid)
- [thickness](2d.McDbBackgroundEntity.md#thickness)
- [trueColor](2d.McDbBackgroundEntity.md#truecolor)
- [visible](2d.McDbBackgroundEntity.md#visible)

### Methods

- [IntersectWith](2d.McDbBackgroundEntity.md#intersectwith)
- [assertObjectModification](2d.McDbBackgroundEntity.md#assertobjectmodification)
- [clearAll](2d.McDbBackgroundEntity.md#clearall)
- [clearDwg](2d.McDbBackgroundEntity.md#cleardwg)
- [clone](2d.McDbBackgroundEntity.md#clone)
- [createExtensionDictionary](2d.McDbBackgroundEntity.md#createextensiondictionary)
- [deleteXData](2d.McDbBackgroundEntity.md#deletexdata)
- [disableDisplay](2d.McDbBackgroundEntity.md#disabledisplay)
- [erase](2d.McDbBackgroundEntity.md#erase)
- [explode](2d.McDbBackgroundEntity.md#explode)
- [getAllAppName](2d.McDbBackgroundEntity.md#getallappname)
- [getArea](2d.McDbBackgroundEntity.md#getarea)
- [getBackgroundDatabase](2d.McDbBackgroundEntity.md#getbackgrounddatabase)
- [getBoundingBox](2d.McDbBackgroundEntity.md#getboundingbox)
- [getDatabase](2d.McDbBackgroundEntity.md#getdatabase)
- [getDatabaseIndexId](2d.McDbBackgroundEntity.md#getdatabaseindexid)
- [getExtensionDictionary](2d.McDbBackgroundEntity.md#getextensiondictionary)
- [getGripEditBasePointsIndex](2d.McDbBackgroundEntity.md#getgripeditbasepointsindex)
- [getGripPoints](2d.McDbBackgroundEntity.md#getgrippoints)
- [getHandle](2d.McDbBackgroundEntity.md#gethandle)
- [getImp](2d.McDbBackgroundEntity.md#getimp)
- [getJson](2d.McDbBackgroundEntity.md#getjson)
- [getObjectID](2d.McDbBackgroundEntity.md#getobjectid)
- [getOwnerID](2d.McDbBackgroundEntity.md#getownerid)
- [getxData](2d.McDbBackgroundEntity.md#getxdata)
- [getxDataDouble](2d.McDbBackgroundEntity.md#getxdatadouble)
- [getxDataLong](2d.McDbBackgroundEntity.md#getxdatalong)
- [getxDataPoint](2d.McDbBackgroundEntity.md#getxdatapoint)
- [getxDataString](2d.McDbBackgroundEntity.md#getxdatastring)
- [highlight](2d.McDbBackgroundEntity.md#highlight)
- [initTempObject](2d.McDbBackgroundEntity.md#inittempobject)
- [isErased](2d.McDbBackgroundEntity.md#iserased)
- [isHaveExtensionDictionary](2d.McDbBackgroundEntity.md#ishaveextensiondictionary)
- [isKindOf](2d.McDbBackgroundEntity.md#iskindof)
- [isNull](2d.McDbBackgroundEntity.md#isnull)
- [isShow](2d.McDbBackgroundEntity.md#isshow)
- [mirror](2d.McDbBackgroundEntity.md#mirror)
- [move](2d.McDbBackgroundEntity.md#move)
- [moveGripPointsAt](2d.McDbBackgroundEntity.md#movegrippointsat)
- [rotate](2d.McDbBackgroundEntity.md#rotate)
- [scaleEntity](2d.McDbBackgroundEntity.md#scaleentity)
- [setJson](2d.McDbBackgroundEntity.md#setjson)
- [setShow](2d.McDbBackgroundEntity.md#setshow)
- [setShowColor](2d.McDbBackgroundEntity.md#setshowcolor)
- [setxData](2d.McDbBackgroundEntity.md#setxdata)
- [setxDataDouble](2d.McDbBackgroundEntity.md#setxdatadouble)
- [setxDataLong](2d.McDbBackgroundEntity.md#setxdatalong)
- [setxDataPoint](2d.McDbBackgroundEntity.md#setxdatapoint)
- [setxDataString](2d.McDbBackgroundEntity.md#setxdatastring)
- [syncData](2d.McDbBackgroundEntity.md#syncdata)
- [transformBy](2d.McDbBackgroundEntity.md#transformby)
- [unErase](2d.McDbBackgroundEntity.md#unerase)
- [updateDisplay](2d.McDbBackgroundEntity.md#updatedisplay)

## Constructors

### constructor

• **new McDbBackgroundEntity**(`x`)
...
▸ **clearDwg**(`sDwgFile`): `boolean`

Clear background display
...
### getBackgroundDatabase

▸ **getBackgroundDatabase**(`sDwgFile`): ``null`` \| [`McDbDatabase`](2d.McDbDatabase.md)

Return the database object used for background display
...
``null`` \| [`McDbDatabase`](2d.McDbDatabase.md)
...
▸ **isShow**(`sDwgFile`): `boolean`

Whether to display background objects
...
▸ **setShow**(`sDwgFile`, `isShow`): `boolean`

Set whether to display background objects
...
▸ **setShowColor**(`sDwgFile`, `lColor`): `boolean`

Replace the display with the specified color when displaying the background
