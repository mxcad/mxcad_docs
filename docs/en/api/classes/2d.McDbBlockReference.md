...
McDbBlockReference is a block reference entity class used to insert block instances in drawings.

**`Description`**

This class is used to represent block reference objects in CAD, and can display instantiated block content based on block definitions.

Summary of usage:
1. First, create or obtain a block definition.
2. Instantiate McDbBlockReference and set its block table record ID, insertion position, scaling, and rotation properties.
3. Finally, display it in the current space.
...
- [normal](2d.McDbBlockReference.md#normal)
...
- [thickness](2d.McDbBlockReference.md#thickness)
...
- [clearSpatialFilterCache](2d.McDbBlockReference.md#clearspatialfiltercache)
- [clone](2d.McDbBlockReference.md#clone)
- [copyAttribute](2d.McDbBlockReference.md#copyattribute)
...
- [createSpatialFilter](2d.McDbBlockReference.md#createspatialfilter)
...
- [eraseAllAttribute](2d.McDbBlockReference.md#eraseallattribute)
...
- [getGripEditBasePointsIndex](2d.McDbBlockReference.md#getgripeditbasepointsindex)
...
- [getSpatialFilterId](2d.McDbBlockReference.md#getspatialfilterid)
...
▸ **copyAttribute**(`to`): `boolean`

Copy the properties of a block reference to another block reference, and the copied block reference must be in the graphics database.

#### Parameters

| Name | Type |
| :------ | :------ |
| `to` | [`McDbBlockReference`](2d.McDbBlockReference.md) |
...
Delete all attributes referenced by the block
...
▸ **getSpatialFilterId**(): [`McObjectId`](2d.McObjectId.md)
