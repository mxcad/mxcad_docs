[mxcad_2d API documentation] (../README. md)/[2d] (../modules/2d. md)/McDbEllipse

# Class: McDbEllipse

[2d](../modules/2d.md).McDbEllipse

Represents an ellipse or elliptical arc entity, used to draw elliptic curves.

**`Description`**

McDbEllipse encapsulates elliptical geometry and supports setting center, main axis, radius ratio, and optional start and end angles.
This class can be used for both complete ellipses and for drawing elliptical arcs and geometric calculations.
Instructions:
1. Create an instance of McDbEllipse.
2. Set 'center', 'major Axis',' radius Ratio ', and set' startAngle 'and' endAngle 'as needed.
3. Add the elliptical entity to the drawing context for display.
...
- [thickness](2d.McDbEllipse.md#thickness)
...
- [getGripEditBasePointsIndex](2d.McDbEllipse.md#getgripeditbasepointsindex)
...
Obtain the starting angle of the elliptical arc
