...
We can call [MxCADUiPrDist](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrDist.html), respectively, dynamic set width and height of the insulation cotton, We can also set a default value for it during the setup process.
...
We by calling [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) take the object to obtain the starting point for the heat preservation cotton respectively.
...
We call after getting the starting line segment according to the starting point of the thermal insulation cotton obtained in the above steps [McDbLine.offsetCurves()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLine.html#offsetcurves)  The offset curve of the position of the starting line segment is obtained. Then call [McDbLine getPointAtDist ()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLine.html#getpointatdist) Methods According to the width and height of the insulation cotton, the center of the circle corresponding to the end point and the arc part of the insulation cotton are intercepted on the offset curve. The last section of the line for [McDbPolyline](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbPolyline.html) all endpoints, and connected to the object To draw arc [McDbArc](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbArc.html), managed to draw heat preservation cotton object.
...
In order to facilitate subsequent management and modification of the entity, We can through inheritance [McDbCustomEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCustomEntity.html) custom entity class to extend heat preservation cotton class.
