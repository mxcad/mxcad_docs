...
We can call [MxCADUiPrDist](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrDist.html), respectively, dynamic set center width and height of the rectangle, We can also set a default value for it during the setup process.
...
We by calling [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) take object determines the location of the center of the rectangle, And according to the above steps in access to high rectangle width by [McDbPolyline](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbPolyline.html) rectangular section of the line to draw more center.
...
In order to facilitate subsequent management and modification of the entity, We can through inheritance [McDbCustomEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCustomEntity.html) custom entity class to extend the rectangle class implementation center.
