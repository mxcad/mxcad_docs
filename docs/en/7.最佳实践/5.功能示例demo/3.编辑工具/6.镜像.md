...
We can call [MxCADSelectionSet](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#class-mxcadselectionset)  Select the entity that you want to mirror.
...
We by calling [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) take the object to determine the image reference line start and end points. During the setup process, We can go through [MxCADUiPrPoint.setUserDraw()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html#setuserdraw)  Dynamically drawing the image object enables us to see the position of the object after the image rotation more intuitively.
...
In the above step, we get the start and end points of the mirror guides, so, We can direct call [McDbEntity.mirror()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEntity.html#mirror) method to image rotation object. After moving, Call [McObject.updateDisplay()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#updatedisplay) method to update the drawing shows.
