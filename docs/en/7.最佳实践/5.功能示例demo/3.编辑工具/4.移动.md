...
We can call [MxCADSelectionSet](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#class-mxcadselectionset)  Select the entity that you want to move.
...
We by calling [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) take the object to determine the basis of moving objects and mobile location. During the setup process, We can go through [MxCADUiPrPoint.setUserDraw()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html#setuserdraw)  Dynamically draw the translation object.
...
In the above step, we get the moving base point and the position after the move, so, We can direct call [McDbEntity.move()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEntity.html#move) approach to moving objects. After moving, Call [McObject.updateDisplay()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#updatedisplay) method to update the drawing shows.
