...
We can call [MxCADResbuf](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADResbuf.html#class-mxcadresbuf) set filters, Then use the [MxCADUiPrEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrEntity.html#class-mxcaduiprentity) Filters out the objects to be migrated.
...
We by calling [MxCADUiPrDist](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrDist.html) according to the users to set two points determine the offset distance.
...
In the above step, we obtained the rotation Angle, so, We can direct call  [McDbCurve.offsetCurves()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCurve.html#offsetcurves) Method to rotate the object. After moving, Call [McObject.updateDisplay()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#updatedisplay) method to update the drawing shows.
