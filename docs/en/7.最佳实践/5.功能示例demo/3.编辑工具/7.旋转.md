...
We can call [MxCADSelectionSet](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#class-mxcadselectionset)  Select the entity that you want to rotate.
...
We by calling [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) take the object to determine the rotation of the object points. Call again [MxCADUiPrAngle](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrAngle.html) for users to set of object rotation Angle. During the setup process, We can go through [MxCADUiPrAngle.setUserDraw()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html#setuserdraw)  Dynamically drawing the image object enables us to see the position of the rotated object more intuitively. Since the redrawing function needs to be continuously performed during the dynamic drawing process, in order to improve the rendering speed and reduce the drawing problem caused by too many rotating objects, We can temporarily consolidate the target object into a block [McDbBlockTableRecord](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbBlockTableRecord.html), In the process of dynamic rendering, the initial rotation is carried out in the form of image blocks, and the target object is rotated after the final rotation Angle is determined.
...
In the above step, we obtained the rotation Angle, so, We can direct call [McDbEntity.rotate()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEntity.html#rotate) method to rotate the object. After moving, Call [McObject.updateDisplay()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#updatedisplay) method to update the drawing shows.
