...
We can call [MxCADUiPrKeyWord](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrKeyWord.html#class-mxcaduiprkeyword)  Keywords are obtained based on user input. Then, invoke [MxCADUiPrKeyWord.setKeyWords()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrKeyWord.html#setkeywords) Method sets the three operations as three options, each corresponding to a keyword.
...
In the above steps, we set three options: hide, hide not selected, and show all. In these three options to hide, hide the unselected two action items we call through [MxCADUtility.userSelect()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#userselect)  Method to get the user selection and do the corresponding hiding operation on the selected entity according to the option. And finally, All display option passed [MxCADSelectionSet.allSelect()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#allselect)  Method displays all hidden entities in the drawing.
