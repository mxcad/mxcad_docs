...
We can call [MxCADSelectionSet](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#class-mxcadselectionset)  Select the entity that you want to scale. Passes the selected entity [McDbBlockTableRecord.appendAcDbEntity()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbBlockTableRecord.html#appendacdbentity) method is consolidated into blocks. And through the properties [McDbBlockTableRecord.origin](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbBlockTableRecord.html#origin) Set the center point of the consolidated block object as the base point.
...
In the following example, we set the scaled entity position to the center point of the reference rectangle. In addition, We can also through [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) take object to dynamically set the position of the object.
