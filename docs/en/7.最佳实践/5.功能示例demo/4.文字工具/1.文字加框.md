...
We according to [McDbEntity.getBoundingBox()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEntity.html#getboundingbox) The minimum bounding box where the text entity is located can be obtained, and the maximum point and minimum point in the minimum bounding box are the two corner points of the text border. Finally, [McDbPolyline](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbPolyline.html#class-mcdbpolyline) section of the line to draw the text frame.
