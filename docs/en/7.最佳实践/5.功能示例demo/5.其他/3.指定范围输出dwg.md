...
We can call [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html#class-mxcaduiprpoint) Method Obtain the scope for exporting dwg drawings.
...
In the above steps we have obtained the scope of the pdf on the drawing, So we can direct call [McObject.saveFileToUrl()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#savefiletourl) Method to export target pdf. If you do not set the scope for exporting drawings, all drawings are exported by default.
...
export default () => {
    ...
    return (<div style="height: 630px; overflow: hidden;">
      ...
      id="myBtn" onClick={()=>Mx_Export_Pdf()}>Specify range output dwg</button>
