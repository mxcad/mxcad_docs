...
In order to facilitate later management and annotation modification, We can through inheritance [McDbCustomEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCustomEntity.html) custom entity class to extend the arc length with class. Among them, the circular object in mxcad corresponding entity class for [McDbArc](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbArc.html), This class provides properties or methods to get or set information about the arc, which we can choose to call according to our functional requirements. In the arc length measurement function, We can call [McDbArc.getLength()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCircle.html#getlength) method to get the arc length.

Then, we can use [McDbText](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbText.html) measurement information text object, the circular arc of the label information on the page.
...
We can choose using entity object [MxCADUiPrEntity()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrEntity.html) According to the coordinates of the user's mouse click, the corresponding entity is obtained, where we need to select only the arc object, so, We'll call [MxCADResbuf()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADResbuf.html) to select entity object set filter to filter out the target entity.
