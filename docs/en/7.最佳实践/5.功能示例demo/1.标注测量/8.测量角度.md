...
We can through setting filter [MxCADResbuf](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADResbuf.html), Combining call [MxCADUiPrEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrEntity.html) Select two unparallel target line objects to be measured in the drawing. During the selection process, in order for us to observe the selected line, We can call [McDbLine.highlight()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLine.html#highlight) method to set the highlighted.
...
According to the above steps, we have obtained two straight lines that need to be marked with angles. So we can call directly [McDb2LineAngularDimension](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDb2LineAngularDimension.html)  Set up the basic information of the angular dimension, call [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) take object setting the location of the label, And through the [MxCADUiPrPoint.setUserDraw()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html#setuserdraw) Methods Dynamic Angle annotation was drawn. Among them, We can use [McObject.addDimStyle()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#adddimstyle) Method Set the basic style of the Angle annotation yourself.
