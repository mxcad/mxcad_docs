...
In order to facilitate later management and modification of annotation objects, We can through inheritance [McDbCustomEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCustomEntity.html) custom entity class, to extend the local class. We call in the drawing according to the enlarged area selected by the user box [MxCADSelectionSet.crossingSelect()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#crossingselect) method gets all the entities in the target region, recall [McDbBlockTableRecord.appendAcDbEntity()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbBlockTableRecord.html#appendacdbentity) method to integrate entity within the region for the block, and then call [McDbSpatialFilter.setBoundary()](../../../../api/classes/2d.McDbSpatialFilter.md#setboundary) method according to their own needs do to block outside the border of the clipping. Finally, the block is scaled according to the set scale factor.
...
We can use take object [MxCADUiPrPoint()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) for the center of the zoom range, Call again [MxCADUiPrDist()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrDist.html) set the zoom range.
