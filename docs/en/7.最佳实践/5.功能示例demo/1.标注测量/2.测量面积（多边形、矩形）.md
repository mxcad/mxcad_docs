...
In order to facilitate later management and annotation modification, We can through inheritance [McDbCustomEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCustomEntity.html) custom entity class to extend the area of annotation classes. Among them, polygons and rectangles are drawn by multi-segment lines in mxcad. Section of the line objects and the corresponding entity class for [McDbPolyline](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbPolyline.html), This class provides properties or methods to get or set information about the graphical object, which we can choose to call according to our functional requirements. In the function of measuring area (polygon, rectangle), We can call [McDbPolyline.getLength()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbPolyline.html#getlength) Method to obtain the length of the multiline object and to call it when the multiline is closed [McDbPolyline.getArea()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbPolyline.html#getarea) method for area.

Then, we can use [McDbMText](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbMText.html) measurement information text object, the object of the label information on the page.
