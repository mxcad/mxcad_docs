...
此外，我们还可以调用实体的 transformBy() 方法复制对象。该方法是通过变换矩阵实现图形的编辑，具体矩阵变换原理可参考[指南数学库中的矩阵-mcgematrix3d](../2.指南/1.数学库.md#矩阵-mcgematrix3d)。

点击 [McGeMatrix3d-clone()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McGeMatrix3d.html#clone) 查看矩形变换详细方法和属性。
...
此外，我们还可以调用实体的 transformBy() 方法镜像处理对象。该方法是通过变换矩阵实现图形的编辑，具体矩阵变换原理可参考[指南数学库中的矩阵-mcgematrix3d](../2.指南/1.数学库.md#矩阵-mcgematrix3d)。

点击 [McGeMatrix3d-setMirror()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McGeMatrix3d.html#setmirror) 查看矩形变换详细方法和属性。
...
此外，我们还可以调用实体的 transformBy() 方法移动对象。该方法是通过变换矩阵实现图形的编辑，具体矩阵变换原理可参考[指南数学库中的矩阵-mcgematrix3d](../2.指南/1.数学库.md#矩阵-mcgematrix3d)。

点击 [McGeMatrix3d-setToTranslation()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McGeMatrix3d.html#settotranslation) 查看矩形变换详细方法和属性。
...
此外，我们还可以调用实体的 transformBy() 方法旋转对象。该方法是通过变换矩阵实现图形的旋转，具体矩阵变换原理可参考[指南数学库中的矩阵-mcgematrix3d](../2.指南/1.数学库.md#矩阵-mcgematrix3d)。
...
```
此外，我们还可以调用实体的 transformBy() 方法缩放对象。该方法是通过变换矩阵实现图形的缩放，具体矩阵变换原理可参考[指南数学库中的矩阵-mcgematrix3d](../2.指南/1.数学库.md#矩阵-mcgematrix3d)。

点击 [McGeMatrix3d-setToScaling()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McGeMatrix3d.html#settoscaling) 查看矩形变换详细方法和属性。
