...
点击 [McObject()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McObject.html) 查看详细属性和方法说明。
...
3. 显示全部：我们可以调用 mxcad 实例对象的 zoomAll() 方法把视区范围设为显示图纸的全部内容。
...
我们可以结合[命令行](../4.%E4%BA%A4%E4%BA%92%E7%BB%98%E5%9B%BE/1.%E5%91%BD%E4%BB%A4%E8%A1%8C.md)执行 `Mx_Pan` 命令实现视区平移功能。
