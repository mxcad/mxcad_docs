...
点击 [字典对象 McDbDictionary()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbDictionary.html)、[扩展记录 McDbXrecord()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbXrecord.html) 查看详细属性和方法说明。
