...
点击[ 数据库层表 McDbLayerTable()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLayerTable.html)、[ 图层表记录对象 McDbLayerTableRecord ](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLayerTableRecord.html)、 [数据库实例 McDbDatabase()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbDatabase.html) 查看详细属性和方法说明。
...
点击[McDbDatabase.getCurrentlyLayerId()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbDatabase.html#getcurrentlylayerid) 查看详细属性和方法说明。
```ts
import { MxCpp} from "mxcad" 
...
点击 [McObject.addLayer()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#addlayer) 查看详细属性和方法说明。
...
点击 [MxCADSelectionSet](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#class-mxcadselectionset) 、[MxCADResbuf](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADResbuf.html#class-mxcadresbuf) 查看详细属性和方法说明。
...
点击 [McDbEntity.layer](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEntity.html#layer)查看详细属性和方法说明。
