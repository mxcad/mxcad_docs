...
点击[ 数据库层表 McDbLayerTable()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McDbLayerTable.html)、[ 图层表记录对象 McDbLayerTableRecord ](https://mxcad.github.io/mxcad_docs/api/classes/2d.McDbLayerTableRecord.html)、 [数据库实例 McDbDatabase()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McDbDatabase.html) 查看详细属性和方法说明。
...
点击 [McObject.addLayer()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McObject.html#addlayer) 查看详细属性和方法说明。
