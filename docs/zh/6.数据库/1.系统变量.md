...
1. 获取浮点数变量[getSysVarDouble](../../api/classes/McObject.md#getsysvardouble),

2. 获取长整数变量[getSysVarLong](../../api/classes/McObject.md#getSysVarLong)

3. 获取点变量[getSysVarPoint](../../api/classes/McObject.md#getSysVarLong)

4. 获取字符串变量[getSysVarString](../../api/classes/McObject.md#getSysVarString)
