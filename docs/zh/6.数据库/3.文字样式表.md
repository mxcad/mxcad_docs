...
点击 [文字样式表 McDbTextStyleTable()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbTextStyleTable.html)、[文字样式表记录对象 McDbTextStyleTableRecord()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLayerTable.html)、[数据库实例 McDbDatabase()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbDatabase.html) 查看详细属性和方法说明。
...
点击[McDbDatabase.getCurrentlyLayerId()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbDatabase.html#getcurrentlytextstyleid) 查看详细属性和方法说明。
...
点击 [McObject.addTextStyle()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#addtextstyle) 查看详细属性和方法说明。
...
点击 [McDbTextStyleTableRecord.fileName](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbTextStyleTableRecord.html#filename)、[McDbTextStyleTableRecord.bigFontFileName](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbTextStyleTableRecord.html#bigfontfilename) 查看详细属性和方法说明。
