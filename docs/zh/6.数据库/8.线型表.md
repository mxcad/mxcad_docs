...
点击 [线型样式表 McDbLinetypeTable()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLinetypeTable.html)、[线型表记录对象 McDbLinetypeTableRecord()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLayerTable.html)、[数据库实例 McDbDatabase()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbDatabase.html) 查看详细属性和方法说明。
...
点击 [McObject.addLinetype()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#addlinetype)、 [McObject.addLinetypeEx()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#addlinetypeex) 查看详细属性和方法说明。
