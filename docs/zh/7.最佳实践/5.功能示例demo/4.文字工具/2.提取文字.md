...
我们可以调用 [MxCADResbuf](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADResbuf.html#class-mxcadresbuf) 设置过滤器，再通过 [MxCADUtility.userSelect()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#userselect) 方法过滤出选择实体中的单行文本对象和多行文本对象。
...
我们根据 [McObjectId.getMcDbEntity()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObjectId.html#getmcdbentity) 获取得到目标文字实体，通过 [McDbEntity.objectName](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbAlignedDimension.html#objectname) 属性获取到实体名字，由于在上述步骤中我们过滤出的都是文字实体，因此我们只需要判断是多行文本类，还是单行文本类，并根据不同的文字类调用相应的文本属性获取文本信息。
