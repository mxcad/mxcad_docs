...
我们根据 [McDbEntity.getBoundingBox()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEntity.html#getboundingbox) 能够获取到文字实体所在的最小包围盒，以该最小包围盒中的最大点和最小点为文字边框的两个角点。最后通过 [McDbPolyline](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbPolyline.html#class-mcdbpolyline) 多段线来绘制文字边框。
