...
我们可以调用 [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html#class-mxcaduiprpoint) 方法获取导出dwg图纸的范围。
...
export default () => {
    ...
    return (<div style="height: 630px; overflow: hidden;">
      ...
      id="myBtn" onClick={()=>Mx_Export_Pdf()}>指定范围输出dwg</button>
