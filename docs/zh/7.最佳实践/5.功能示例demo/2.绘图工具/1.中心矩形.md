...
我们可以调用 [MxCADUiPrDist](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrDist.html) 分别动态设置中心矩形的宽度与高度，在设置过程中我们也可以为其设置默认值。
...
我们通过调用 [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) 取点对象来确定矩形中心点的位置，并根据上述步骤中获取到的矩形宽高通过 [McDbPolyline](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbPolyline.html) 多段线来绘制中心矩形。
...
为了方便后期管理与修改实体，我们可以通过继承 [McDbCustomEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCustomEntity.html) 自定义实体类来扩展实现中心矩形类。
