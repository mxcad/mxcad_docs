...
我们可以调用 [MxCADUiPrDist](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrDist.html) 分别动态设置保温棉的宽度与高度，在设置过程中我们也可以为其设置默认值。
...
我们通过调用 [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) 取点对象来分别获取保温棉的起始点。
...
我们根据上述步骤中获得的保温棉起始点得到起始线段后调用 [McDbLine.offsetCurves()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLine.html#offsetcurves) 得到该起始线段所在位置的偏移曲线，然后调用 [McDbLine.getPointAtDist()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLine.html#getpointatdist) 方法在偏移后的曲线上根据保温棉的宽高去截取端点和保温棉中圆弧部分对应的圆心，最后以 [McDbPolyline](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbPolyline.html) 多段线对象连接所有端点和 [McDbArc](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbArc.html) 绘制圆弧，最终成功绘制保温棉对象。
...
为了方便后期管理与修改实体，我们可以通过继承 [McDbCustomEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCustomEntity.html) 自定义实体类来扩展实现保温棉类。
