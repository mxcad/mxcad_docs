...
我们可以通过 [MxCADResbuf](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADResbuf.html) 设置过滤器，再结合调用 [MxCADUiPrEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrEntity.html) 在图纸中选取需要测量的两条不平行的目标直线对象。在选取过程中，为了方便我们观察选中的直线，我们可以调用 [McDbLine.highlight()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbLine.html#highlight) 方法设置高亮。
...
根据上述步骤我们已经获得了需要标注角度的两条直线，因此我们可以直接调用 [McDb2LineAngularDimension](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDb2LineAngularDimension.html) 设置角度标注的基本信息，调用 [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) 取点对象设置标注点的位置，并通过 [MxCADUiPrPoint.setUserDraw()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html#setuserdraw) 方法动态绘制角度标注。其中，我们可以通过 [McObject.addDimStyle()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#adddimstyle) 方法自己设置角度标注的基本样式。
