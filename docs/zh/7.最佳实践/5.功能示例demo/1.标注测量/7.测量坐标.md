...
为了方便后期管理与修改标注，我们可以通过继承 [McDbCustomEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCustomEntity.html) 自定义实体类来扩展实现坐标标注类。然后，我们可以利用 [McDbMText](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbMText.html) 构造测量信息多文本对象，将坐标的标注信息绘制在页面中。
