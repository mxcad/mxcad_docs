...
为了方便后期管理与修改标注，我们可以通过继承 [McDbCustomEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCustomEntity.html) 自定义实体类来扩展实现圆标注类。其中，在 mxcad 中圆对象对应的实体类为 [McDbCircle](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCircle.html) ，该类提供了获取或设置圆相关信息的属性或方法，我们可以根据我们的功能需求去选择调用。在测量圆功能中，我们需要获取圆对象的半径、面积与周长，因此我们可以调用 [McDbCircle.radius](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCircle.html#radius) 属性获取圆半径，[McDbCircle.getArea()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCircle.html#getarea) 方法或直接计算来获取圆面积，以及 [McDbCircle.getLength()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCircle.html#getlength) 方法获取圆周长。

然后，我们可以利用 [McDbMText](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbMText.html) 构造测量信息多文本对象，将圆的标注信息绘制在页面中。
...
我们可以利用选择实体对象 [MxCADUiPrEntity()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrEntity.html) 根据用户鼠标点击的坐标得到对应的实体，其中我们需要只选择圆对象，因此，我们再调用 [MxCADResbuf()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADResbuf.html) 为选择实体对象设置过滤器来过滤出目标实体。
...
我们可以利用 [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) 取点对象在页面中交互取点。在取点过程中，我们可以通过 [MxCADUiPrPoint.setUserDraw()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html#setuserdraw) 方法动态绘制标注对象，使用户更加直观的观察到标注对象的位置变化。
