...
我们可以调用 [MxCADSelectionSet](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#class-mxcadselectionset) 选择需要进行镜像旋转的实体。
...
我们通过调用 [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) 取点对象来确定镜像参考线的开始点和结束点。在设置过程中，我们可以通过 [MxCADUiPrPoint.setUserDraw()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html#setuserdraw) 动态绘制镜像对象，能够使我们更加直观的看到镜像旋转后的对象位置。
...
在上述步骤中，我们获取到了镜像参考线的开始点与结束点，因此，我们可以直接调用 [McDbEntity.mirror()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEntity.html#mirror) 方法来镜像旋转对象。移动后，调用 [McObject.updateDisplay()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#updatedisplay) 方法来更新图纸显示。
