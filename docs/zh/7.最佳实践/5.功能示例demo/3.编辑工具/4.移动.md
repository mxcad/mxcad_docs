...
我们可以调用 [MxCADSelectionSet](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADSelectionSet.html#class-mxcadselectionset) 选择需要进行移动的实体。
...
我们通过调用 [MxCADUiPrPoint](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) 取点对象来确定移动对象的基点和移动后的位置。在设置过程中，我们可以通过 [MxCADUiPrPoint.setUserDraw()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html#setuserdraw) 动态绘制平移对象。
...
在上述步骤中，我们获取到了移动的基点和移动后的位置，因此，我们可以直接调用 [McDbEntity.move()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEntity.html#move) 方法来移动对象。移动后，调用 [McObject.updateDisplay()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#updatedisplay) 方法来更新图纸显示。
