...
我们可以调用 [MxCADResbuf](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADResbuf.html#class-mxcadresbuf) 设置过滤器，然后使用 [MxCADUiPrEntity](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrEntity.html#class-mxcaduiprentity) 筛选出需要进行偏移的对象。
...
我们通过调用 [MxCADUiPrDist](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrDist.html) 根据用户设置的两个点确定偏移距离。
...
在上述步骤中，我们获取到了旋转角度，因此，我们可以直接调用 [McDbCurve.offsetCurves()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbCurve.html#offsetcurves) 方法来旋转对象。移动后，调用 [McObject.updateDisplay()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#updatedisplay) 方法来更新图纸显示。
