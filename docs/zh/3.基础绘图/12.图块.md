...
点击 [McDbBlockReference()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbBlockReference.html)、 [McDbBlockTableRecord()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbBlockTableRecord.html) 查看详细属性和方法说明。
