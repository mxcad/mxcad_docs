...
标注是在图纸中用于提供关于尺寸、位置和方向等信息的一种图形元素；是进行图形识读和指导生产的主要技术依据。可以根据需求在多种方位上为各类对象创建标注。mxcad 中提供了对齐标注尺寸类和旋转标注尺寸类，若你有其他标注需求如：审图标注、箭头标注、云线标注等可参考 [mxdraw库](https://mxcad.github.io/mxdraw_docs/start/abstract.html) 中提供的尺寸标注方法。
...
点击 [McDbAlignedDimension()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McDbAlignedDimension.html) 查看详细属性和方法说明。

点击 [drawDimAligned()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McObject.html#drawdimaligned) 查看详细属性和方法说明。
...
点击 [McDbRotatedDimension()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McDbRotatedDimension.html)、[drawDimRotated()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McObject.html#drawdimrotated) 查看详细属性和方法说明。
...
点击 [drawDimAngular()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McObject.html#drawdimangular) 查看详细属性和方法说明。
