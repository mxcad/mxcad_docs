...
点击 [McDbText()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbText.html) 查看详细属性和方法说明。
...
点击 [McDbMText()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbMText.html) 查看详细属性和方法说明。
