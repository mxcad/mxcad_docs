...
点击 [McDbText()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McDbText.html) 查看详细属性和方法说明。
...
点击 [McDbMText()](https://mxcad.github.io/mxcad_docs/api/classes/2d.McDbMText.html) 查看详细属性和方法说明。
