...
点击 [McDbEllipse()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbEllipse.html) 查看详细属性和方法说明。

点击 [drawEllipse()、drawEllipseArc()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#drawellipse) 查看详细属性和方法说明。
