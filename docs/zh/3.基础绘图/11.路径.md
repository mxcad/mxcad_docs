...
点击 [path路径](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#pathlineto) 、[drawPath绘制路径](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#drawpathtopolyline) 查看详细属性和方法说明。
