...
点击 [McDbPoint()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McDbPoint.html)  查看详细属性和方法说明。

点击 [drawPoint()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.McObject.html#drawpoint)  查看详细属性和方法说明。
