...
点击 [MxCADUiPrBase()](https://www.mxdraw3d.com/mxcad_docs/api/classes/MxCADUiPrBase.html) 查看详细属性和方法说明。

## 取点对象 MxCADUiPrPoint()

我们可以通过 MxCADUiPrPoint() 实例化一个点对象。该点对象的值为鼠标点击画布时的坐标位置，使用该点对象与[命令行](./1.%E5%91%BD%E4%BB%A4%E8%A1%8C.md)结合，设置关键字列表实现完整的命令功能。下面为取点对象的基础使用，若你还有其他需求可参考该取点对象的API文档自行实现。

点击 [MxCADUiPrPoint()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrPoint.html) 查看详细属性和方法说明。
...
点击 [MxCADUiPrInt()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrInt.html)、[MxCADUiPrKeyWord()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrInt.html)、[MxCADUiPrString()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrInt.html) 查看详细属性和方法说明。
...
点击 [MxCADUiPrDist()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrDist.html)、[MxCADUiPrAngle()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrAngle.html) 查看详细属性和方法说明。
...
点击 [MxCADUiPrEntity()](https://www.mxdraw3d.com/mxcad_docs/api/classes/2d.MxCADUiPrEntity.html) 查看详细属性和方法说明。
