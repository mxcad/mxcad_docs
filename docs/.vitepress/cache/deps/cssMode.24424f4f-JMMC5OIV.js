...
// node_modules/vitepress-demo-editor/dist/cssMode.24424f4f.js
var Fe = Object.defineProperty;
var Le = (e, n, i) => n in e ? Fe(e, n, { enumerable: true, configurable: true, writable: true, value: i }) : e[n] = i;
var k = (e, n, i) => (Le(e, typeof n != "symbol" ? n + "" : n, i), i);
...
(function(e) {
  function n(i) {
    ...
    return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every(function(t) {
      return s.string(t.kind) ? S.is(t) || M.is(t) || F.is(t) : U.is(t);
    }));
  }
  e.is = n;
})(q || (q = {}));
    ...
    return this._worker(t).then((a) => a.doComplete(t.toString(), E(n))).then((a) => {
      ...
      const o = e.getWordUntilPosition(n), u = new c.Range(n.lineNumber, o.startColumn, n.lineNumber, o.endColumn), g = a.items.map((d) => {
        const v = {
          ...
          detail: d.detail,
          command: Ye(d.command),
          range: u,
          kind: Je(d.kind)
        };
        return d.textEdit && (Ge(d.textEdit) ? v.range = {
...
var at = class {
  ...
  provideRenameEdits(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.doRename(t.toString(), E(n), i)).then((a) => ot(a));
  }
};
function ot(e) {
  if (!e || !e.changes)
...
var dt = class {
  ...
  provideDocumentRangeFormattingEdits(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.format(t.toString(), De(n), Se(i)).then((o) => {
      if (!(!o || o.length === 0))
        return o.map(j);
    }));
  }
...
vitepress-demo-editor/dist/cssMode.24424f4f.js:
  (*!-----------------------------------------------------------------------------
   ...
   *-----------------------------------------------------------------------------*)
*/
//# sourceMappingURL=cssMode.24424f4f-JMMC5OIV.js.map
