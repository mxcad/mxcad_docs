...
// node_modules/vitepress-demo-editor/dist/tsMode.07b62794.js
var N = Object.defineProperty;
var M = (e, t, r) => t in e ? N(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r;
var _ = (e, t, r) => (M(e, typeof t != "symbol" ? t + "" : t, r), r);
var L = Object.defineProperty;
var E = Object.getOwnPropertyDescriptor;
var H = Object.getOwnPropertyNames;
var V = Object.prototype.hasOwnProperty;
var W = (e, t, r) => t in e ? L(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r;
var j = (e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let a of H(t))
      !V.call(e, a) && (r || a !== "default") && L(e, a, { get: () => t[a], enumerable: !(s = E(t, a)) || s.enumerable });
  return e;
};
...
var B = class {
  ...
  _getClient() {
    if (!this._client) {
      ...
      this._defaults.getEagerModelSync() && (e = e.then((t) => this._worker ? this._worker.withSyncedResources(i.editor.getModels().filter((r) => r.getLanguageId() === this._modeId).map((r) => r.uri)) : t)), this._client = e;
    }
    return this._client;
  }
...
o["lib.d.ts"] = true;
o["lib.dom.d.ts"] = true;
o["lib.dom.iterable.d.ts"] = true;
o["lib.es2015.collection.d.ts"] = true;
o["lib.es2015.core.d.ts"] = true;
o["lib.es2015.d.ts"] = true;
o["lib.es2015.generator.d.ts"] = true;
o["lib.es2015.iterable.d.ts"] = true;
o["lib.es2015.promise.d.ts"] = true;
o["lib.es2015.proxy.d.ts"] = true;
o["lib.es2015.reflect.d.ts"] = true;
o["lib.es2015.symbol.d.ts"] = true;
o["lib.es2015.symbol.wellknown.d.ts"] = true;
o["lib.es2016.array.include.d.ts"] = true;
o["lib.es2016.d.ts"] = true;
o["lib.es2016.full.d.ts"] = true;
o["lib.es2017.d.ts"] = true;
o["lib.es2017.full.d.ts"] = true;
o["lib.es2017.intl.d.ts"] = true;
o["lib.es2017.object.d.ts"] = true;
o["lib.es2017.sharedmemory.d.ts"] = true;
o["lib.es2017.string.d.ts"] = true;
o["lib.es2017.typedarrays.d.ts"] = true;
o["lib.es2018.asyncgenerator.d.ts"] = true;
o["lib.es2018.asynciterable.d.ts"] = true;
o["lib.es2018.d.ts"] = true;
o["lib.es2018.full.d.ts"] = true;
o["lib.es2018.intl.d.ts"] = true;
o["lib.es2018.promise.d.ts"] = true;
o["lib.es2018.regexp.d.ts"] = true;
o["lib.es2019.array.d.ts"] = true;
o["lib.es2019.d.ts"] = true;
o["lib.es2019.full.d.ts"] = true;
o["lib.es2019.object.d.ts"] = true;
o["lib.es2019.string.d.ts"] = true;
o["lib.es2019.symbol.d.ts"] = true;
o["lib.es2020.bigint.d.ts"] = true;
o["lib.es2020.d.ts"] = true;
o["lib.es2020.full.d.ts"] = true;
o["lib.es2020.intl.d.ts"] = true;
o["lib.es2020.promise.d.ts"] = true;
o["lib.es2020.sharedmemory.d.ts"] = true;
o["lib.es2020.string.d.ts"] = true;
o["lib.es2020.symbol.wellknown.d.ts"] = true;
o["lib.es2021.d.ts"] = true;
o["lib.es2021.full.d.ts"] = true;
o["lib.es2021.intl.d.ts"] = true;
o["lib.es2021.promise.d.ts"] = true;
o["lib.es2021.string.d.ts"] = true;
o["lib.es2021.weakref.d.ts"] = true;
o["lib.es5.d.ts"] = true;
o["lib.es6.d.ts"] = true;
o["lib.esnext.d.ts"] = true;
o["lib.esnext.full.d.ts"] = true;
o["lib.esnext.intl.d.ts"] = true;
o["lib.esnext.promise.d.ts"] = true;
o["lib.esnext.string.d.ts"] = true;
o["lib.esnext.weakref.d.ts"] = true;
o["lib.scripthost.d.ts"] = true;
o["lib.webworker.d.ts"] = true;
o["lib.webworker.importscripts.d.ts"] = true;
o["lib.webworker.iterable.d.ts"] = true;
function F(e, t, r = 0) {
  if (typeof e == "string")
    return e;
  if (e === void 0)
...
var U = class {
  constructor(e) {
    ...
    this._worker = e, this._libFiles = {}, this._hasFetchedLibFiles = false, this._fetchLibFilesPromise = null;
  }
  isLibFile(e) {
    return e && e.path.indexOf("/lib.") === 0 ? !!o[e.path.slice(1)] : false;
  }
  getOrCreateModel(e) {
  ...
  _fetchLibFiles() {
    return this._fetchLibFilesPromise || (this._fetchLibFilesPromise = this._worker().then((e) => e.getLibFiles()).then((e) => {
      this._hasFetchedLibFiles = true, this._libFiles = e;
  ...
  constructor(t, r, s, a) {
    ...
    const u = (n) => {
      ...
      this._listener[n.uri.toString()] = {
        dispose() {
          f.dispose(), b.dispose(), clearTimeout(d);
        }
      }, p();
    }, c = (n) => {
    ...
    return !p || e.isDisposed() ? void 0 : {
      suggestions: p.entries.map((f) => {
        ...
        if (f.replacementSpan) {
          ...
          b = new i.Range(v.lineNumber, v.column, C.lineNumber, C.column);
        }
        const y = [];
...
var O = class extends w {
  ...
  async provideSignatureHelp(t, r, s, a) {
    ...
    const n = await g.getSignatureHelpItems(u.toString(), c, {
      triggerReason: O._toSignatureHelpTriggerReason(a)
    });
    if (!n || t.isDisposed())
      return;
    const p = {
    ...
    return n.items.forEach((d) => {
      ...
      }, f.label += k(d.prefixDisplayParts), d.parameters.forEach((b, y, x) => {
        const v = k(b.displayParts), C = {
          label: v,
          documentation: {
            value: k(b.documentation)
          }
        };
...
var z = class extends w {
  async provideHover(e, t, r) {
    ...
    if (!c || e.isDisposed())
      return;
    const g = k(c.documentation), n = c.tags ? c.tags.map((d) => P(d)).join(`  
...
h(l, "module", "module");
h(l, "class", "class");
h(l, "interface", "interface");
h(l, "type", "type");
h(l, "enum", "enum");
h(l, "variable", "var");
h(l, "localVariable", "local var");
h(l, "function", "function");
h(l, "localFunction", "local function");
h(l, "memberFunction", "method");
h(l, "memberGetAccessor", "getter");
h(l, "memberSetAccessor", "setter");
h(l, "memberVariable", "property");
h(l, "constructorImplementation", "constructor");
h(l, "callSignature", "call");
h(l, "indexSignature", "index");
h(l, "constructSignature", "construct");
h(l, "parameter", "parameter");
h(l, "typeParameter", "type parameter");
h(l, "primitiveType", "primitive type");
h(l, "label", "label");
h(l, "alias", "alias");
h(l, "const", "const");
h(l, "let", "let");
...
var Z = class extends S {
  async provideCodeActions(e, t, r, s) {
    const a = e.uri, u = e.getOffsetAt({
      ...
      lineNumber: t.endLineNumber,
      column: t.endColumn
    }), g = S._convertOptions(e.getOptions()), n = r.markers.filter((b) => b.code).map((b) => b.code).map(Number), p = await this._worker(a);
    if (e.isDisposed())
      return;
    const d = await p.getCodeFixesAtPosition(a.toString(), u, c, n, g);
    return !d || e.isDisposed() ? { actions: [], dispose: () => {
    } } : {
      actions: d.filter((b) => b.changes.filter((y) => y.isNewFile).length === 0).map((b) => this._tsCodeFixActionToMonacoCodeAction(e, r, b)),
      dispose: () => {
      }
    };
  }
...
var ee = class extends w {
  ...
  async provideRenameEdits(e, t, r, s) {
    ...
    const p = await g.findRenameLocations(u, c, false, false, false);
    if (!p || e.isDisposed())
      return;
    const d = [];
    for (const f of p) {
      const b = this._libFiles.getOrCreateModel(f.fileName);
      if (b)
        d.push({
          resource: b.uri,
          edit: {
            range: this._textSpanToRange(b, f.textSpan),
            text: r
          }
        });
      else
...
function I(e, t) {
  const r = new B(t, e), s = (...u) => r.getLanguageServiceWorker(...u), a = new U(s);
  return i.languages.registerCompletionItemProvider(t, new D(s)), i.languages.registerSignatureHelpProvider(t, new O(s)), i.languages.registerHoverProvider(t, new z(s)), i.languages.registerDocumentHighlightProvider(t, new G(s)), i.languages.registerDefinitionProvider(t, new J(a, s)), i.languages.registerReferenceProvider(t, new Q(a, s)), i.languages.registerDocumentSymbolProvider(t, new q(s)), i.languages.registerDocumentRangeFormattingEditProvider(t, new X(s)), i.languages.registerOnTypeFormattingEditProvider(t, new Y(s)), i.languages.registerCodeActionProvider(t, new Z(s)), i.languages.registerRenameProvider(t, new ee(a, s)), i.languages.registerInlayHintsProvider(t, new te(s)), new $(a, e, t, s), s;
}
export {
  w as Adapter,
  Z as CodeActionAdaptor,
  J as DefinitionAdapter,
  $ as DiagnosticsAdapter,
  X as FormatAdapter,
  S as FormatHelper,
  Y as FormatOnTypeAdapter,
  te as InlayHintsAdapter,
  l as Kind,
  U as LibFiles,
  G as OccurrencesAdapter,
  q as OutlineAdapter,
  z as QuickInfoAdapter,
  ...
  ae as getJavaScriptWorker,
  oe as getTypeScriptWorker,
  ne as setupJavaScript,
  ie as setupTypeScript
};
/*! Bundled license information:

vitepress-demo-editor/dist/tsMode.07b62794.js:
  (*!-----------------------------------------------------------------------------
   ...
   *-----------------------------------------------------------------------------*)
*/
//# sourceMappingURL=tsMode.07b62794-MM5W74UH.js.map
