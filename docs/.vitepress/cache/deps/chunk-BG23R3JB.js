...
// node_modules/vitepress-demo-editor/dist/index.801be2e1.js
var c = {};
var u = {};
function m(e) {
  c = e;
...
var p;
async function O() {
  const e = await import("./editor.main.d83c2780-S7XXMVIQ.js").then((n) => n.e);
  ...
  `, "ts:vue"), await Promise.all([
    (async () => {
      const [
        ...
        import("./editor.worker.9c35f395-F2BA4MZQ.js"),
        import("./html.worker.b57725c2-OOHLC5UM.js"),
        import("./ts.worker.3260b66b-JYKEJMWS.js")
      ]);
...
var M = function(e, n) {
  ...
  const r = defineAsyncComponent(() => import("./Demo.10a78ca5-KFWWLHS5.js"));
...
//# sourceMappingURL=chunk-BG23R3JB.js.map
