...
// node_modules/vitepress-demo-editor/dist/htmlMode.d62ba9fd.js
var Le = Object.defineProperty;
var Fe = (e, n, i) => n in e ? Le(e, n, { enumerable: true, configurable: true, writable: true, value: i }) : e[n] = i;
var k = (e, n, i) => (Fe(e, typeof n != "symbol" ? n + "" : n, i), i);
...
var Ue = (e, n, i, r) => {
  if (n && typeof n == "object" || typeof n == "function")
    for (let t of He(n))
      !Oe.call(e, t) && (i || t !== "default") && Ne(e, t, { get: () => n[t], enumerable: !(r = We(n, t)) || r.enumerable });
  return e;
};
var c = {};
Ue(c, wp);
...
var ze = class {
  ...
  _checkIfIdle() {
    if (!this._worker)
      return;
    Date.now() - this._lastUsedTime > Ve && this._stopWorker();
  }
  _getClient() {
...
(function(e) {
  ...
  function i(r) {
    var t = r;
    return s.string(t.label) && (s.undefined(t.textEdit) || A.is(t)) && (s.undefined(t.additionalTextEdits) || s.typedArray(t.additionalTextEdits, A.is));
  }
  e.is = i;
})(ee || (ee = {}));
var P;
...
(function(e) {
  ...
  function t(a) {
    var o = a;
    return A.is(o) && (R.is(o.annotationId) || m.is(o.annotationId));
  }
  e.is = t;
})(C || (C = {}));
var U;
...
(function(e) {
  function n(i) {
    ...
    return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every(function(t) {
      return s.string(t.kind) ? D.is(t) || M.is(t) || L.is(t) : U.is(t);
    }));
  }
  e.is = n;
})(q || (q = {}));
var W = function() {
  ...
  return e.prototype.insert = function(n, i, r) {
    var t, a;
    if (r === void 0 ? t = A.insert(n, i) : m.is(r) ? (a = r, t = C.insert(n, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), t = C.insert(n, i, a)), this.edits.push(t), a !== void 0)
      return a;
  }, e.prototype.replace = function(n, i, r) {
    var t, a;
    if (r === void 0 ? t = A.replace(n, i) : m.is(r) ? (a = r, t = C.replace(n, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), t = C.replace(n, i, a)), this.edits.push(t), a !== void 0)
      return a;
  }, e.prototype.delete = function(n, i) {
    var r, t;
    if (i === void 0 ? r = A.del(n) : m.is(i) ? (t = i, r = C.del(n, i)) : (this.assertChangeAnnotations(this.changeAnnotations), t = this.changeAnnotations.manage(i), r = C.del(n, t)), this.edits.push(r), t !== void 0)
      return t;
...
(function() {
  ...
  return Object.defineProperty(e.prototype, "edit", {
    ...
    var a, o;
    if (t === void 0 ? a = D.create(n, r) : (o = m.is(t) ? t : this._changeAnnotations.manage(t), a = D.create(n, r, o)), this._workspaceEdit.documentChanges.push(a), o !== void 0)
      return o;
    ...
    var o, u;
    if (a === void 0 ? o = M.create(n, i, t) : (u = m.is(a) ? a : this._changeAnnotations.manage(a), o = M.create(n, i, t, u)), this._workspaceEdit.documentChanges.push(o), u !== void 0)
      return u;
    ...
    R.is(i) || m.is(i) ? t = i : r = i;
    var a, o;
    if (t === void 0 ? a = L.create(n, r) : (o = m.is(t) ? t : this._changeAnnotations.manage(t), a = L.create(n, r, o)), this._workspaceEdit.documentChanges.push(a), o !== void 0)
      return o;
  }, e;
})();
var ae;
...
(function(e) {
  function n(r, t, a) {
    var o = { title: r }, u = true;
    return typeof t == "string" ? (u = false, o.kind = t) : T.is(t) ? o.command = t : o.edit = t, u && a !== void 0 && (o.kind = a), o;
  }
  e.create = n;
  function i(r) {
    var t = r;
    return t && s.string(t.title) && (t.diagnostics === void 0 || s.typedArray(t.diagnostics, O.is)) && (t.kind === void 0 || s.string(t.kind)) && (t.edit !== void 0 || t.command !== void 0) && (t.command === void 0 || T.is(t.command)) && (t.isPreferred === void 0 || s.boolean(t.isPreferred)) && (t.edit === void 0 || q.is(t.edit));
  }
  e.is = i;
})(Ee || (Ee = {}));
var xe;
(function(e) {
  ...
  function i(r) {
    var t = r;
    return s.defined(t) && p.is(t.range) && (s.undefined(t.command) || T.is(t.command));
  }
  e.is = i;
})(xe || (xe = {}));
var Ce;
...
(function(e) {
  ...
  e.is = i;
  function r(a, o) {
    for (var u = a.getText(), g = t(o, function(I, N) {
      var J = I.range.start.line - N.range.start.line;
      return J === 0 ? I.range.start.character - N.range.start.character : J;
    }), d = u.length, v = g.length - 1; v >= 0; v--) {
      var w = g[v], x = a.offsetAt(w.range.start), f = a.offsetAt(w.range.end);
      if (f <= d)
        u = u.substring(0, x) + w.newText + u.substring(f, u.length);
      else
  ...
  function t(a, o) {
    ...
    t(g, o), t(d, o);
    for (var v = 0, w = 0, x = 0; v < g.length && w < d.length; ) {
      var f = o(g[v], d[w]);
      f <= 0 ? a[x++] = g[v++] : a[x++] = d[w++];
    }
    for (; v < g.length; )
...
var Xe = function() {
  ...
  return Object.defineProperty(e.prototype, "uri", {
    ...
    if (this._lineOffsets === void 0) {
      for (var n = [], i = this._content, r = true, t = 0; t < i.length; t++) {
        r && (n.push(t), r = false);
        var a = i.charAt(t);
        r = a === "\r" || a === `
...
(function(e) {
  ...
  e.number = o;
  function u(f, I, N) {
    return n.call(f) === "[object Number]" && I <= f && f <= N;
  }
  e.numberRange = u;
  function g(f) {
  ...
  e.objectLiteral = w;
  function x(f, I) {
    return Array.isArray(f) && f.every(I);
  }
  e.typedArray = x;
})(s || (s = {}));
var mt = class {
...
var qe = class {
  ...
  provideCompletionItems(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.doComplete(t.toString(), E(n))).then((a) => {
      if (!a)
        return;
  ...
  resolveCompletionItem(e, n) {
    const i = e.uri, r = e.position;
    return this._worker(i).then((t) => t.doResolve(i.toString(), r, e));
  }
};
function E(e) {
  if (!!e)
...
var Ye = class {
  ...
  provideHover(e, n, i) {
    let r = e.uri;
    return this._worker(r).then((t) => t.doHover(r.toString(), E(n))).then((t) => {
      if (!!t)
        return {
          range: _(t.range),
          contents: Ke(t.contents)
        };
    });
  }
};
...
var et = class {
  ...
  provideDocumentHighlights(e, n, i) {
    const r = e.uri;
    return this._worker(r).then((t) => t.findDocumentHighlights(r.toString(), E(n))).then((t) => {
      if (!!t)
        return t.map((a) => ({
          range: _(a.range),
          kind: tt(a.kind)
...
var _t = class {
  ...
  provideDefinition(e, n, i) {
    const r = e.uri;
    return this._worker(r).then((t) => t.findDefinition(r.toString(), E(n))).then((t) => {
      if (!!t)
        return [Te(t)];
    });
  }
...
var wt = class {
  ...
  provideReferences(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.findReferences(t.toString(), E(n))).then((a) => {
      if (!!a)
        return a.map(Te);
    });
  }
...
var rt = class {
  ...
  provideRenameEdits(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.doRename(t.toString(), E(n), i)).then((a) => nt(a));
  }
};
function nt(e) {
  if (!e || !e.changes)
...
var st = class {
  ...
  provideDocumentFormattingEdits(e, n, i) {
    const r = e.uri;
    return this._worker(r).then((t) => t.format(r.toString(), null, De(n)).then((a) => {
      if (!(!a || a.length === 0))
        return a.map(j);
    }));
  }
...
var ut = class {
  ...
  provideDocumentRangeFormattingEdits(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.format(t.toString(), Se(n), De(i)).then((o) => {
      if (!(!o || o.length === 0))
        return o.map(j);
    }));
  }
...
var ft = class {
  ...
  provideSelectionRanges(e, n, i) {
    const r = e.uri;
    return this._worker(r).then((t) => t.getSelectionRanges(r.toString(), n.map(E))).then((t) => {
      if (!!t)
        return t.map((a) => {
          const o = [];
          for (; a; )
...
var gt = class {
  constructor(e) {
    k(this, "signatureHelpTriggerCharacters", ["(", ","]);
    this._worker = e;
  }
  async provideSignatureHelp(e, n, i) {
    const r = e.uri;
    return this._worker(r).then((t) => t.getSignatureHelpItems(r.toString(), E(n))).then((t) => {
      if (!(!t || e.isDisposed()))
        return { value: t, dispose() {
        } };
    });
  }
};
var lt = class {
  ...
  provideCompletionItems(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.doAutoInsert(t.toString(), E(n))).then((a) => {
      if (!(!a || e.isDisposed()))
        return {
          isIncomplete: true,
          suggestions: [
            {
              ...
              kind: c.languages.CompletionItemKind.Property,
              documentation: a,
              insertText: a,
...
var ht = class extends qe {
  constructor(e) {
    super(e, [".", ":", "<", '"', "=", "/"]);
  }
};
function bt(e) {
  const n = [], i = [], r = new ze(e);
  n.push(r);
  const t = (...o) => r.getLanguageServiceWorker(...o);
  function a() {
    const { languageId: o, modeConfiguration: u } = e;
    Me(i), u.completionItems && i.push(c.languages.registerCompletionItemProvider(o, new ht(t))), u.hovers && i.push(c.languages.registerHoverProvider(o, new Ye(t))), u.documentHighlights && i.push(c.languages.registerDocumentHighlightProvider(o, new et(t))), u.links && i.push(c.languages.registerLinkProvider(o, new ot(t))), u.documentSymbols && i.push(c.languages.registerDocumentSymbolProvider(o, new it(t))), u.rename && i.push(c.languages.registerRenameProvider(o, new rt(t))), u.foldingRanges && i.push(c.languages.registerFoldingRangeProvider(o, new ct(t))), u.selectionRanges && i.push(c.languages.registerSelectionRangeProvider(o, new ft(t))), u.documentFormattingEdits && i.push(c.languages.registerDocumentFormattingEditProvider(o, new st(t))), u.documentRangeFormattingEdits && i.push(c.languages.registerDocumentRangeFormattingEditProvider(o, new ut(t))), u.signatureHelp && i.push(c.languages.registerSignatureHelpProvider(o, new gt(t))), c.languages.registerCompletionItemProvider(o, new lt(t));
  }
...
export {
  lt as CloseTagAdapter,
  qe as CompletionAdapter,
  _t as DefinitionAdapter,
  mt as DiagnosticsAdapter,
  kt as DocumentColorAdapter,
  st as DocumentFormattingEditProvider,
  et as DocumentHighlightAdapter,
  ot as DocumentLinkAdapter,
  ut as DocumentRangeFormattingEditProvider,
  it as DocumentSymbolAdapter,
  ct as FoldingRangeAdapter,
  Ye as HoverAdapter,
  wt as ReferenceAdapter,
  rt as RenameAdapter,
  ft as SelectionRangeAdapter,
  gt as SignatureHelpAdapter,
  ze as WorkerManager,
  E as fromPosition,
  Se as fromRange,
  bt as setupMode,
...
vitepress-demo-editor/dist/htmlMode.d62ba9fd.js:
  (*!-----------------------------------------------------------------------------
   ...
   *-----------------------------------------------------------------------------*)
*/
//# sourceMappingURL=htmlMode.d62ba9fd-A34BNS6Y.js.map
