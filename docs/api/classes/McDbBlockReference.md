...
- [blockName](McDbBlockReference.md#blockname)
- [blockTableRecordId](McDbBlockReference.md#blocktablerecordid)
- [blockTransform](McDbBlockReference.md#blocktransform)
- [colorIndex](McDbBlockReference.md#colorindex)
- [dxf0](McDbBlockReference.md#dxf0)
- [layer](McDbBlockReference.md#layer)
- [layerId](McDbBlockReference.md#layerid)
- [linetype](McDbBlockReference.md#linetype)
- [linetypeId](McDbBlockReference.md#linetypeid)
- [linetypeScale](McDbBlockReference.md#linetypescale)
- [lineweight](McDbBlockReference.md#lineweight)
...
- [textStyle](McDbBlockReference.md#textstyle)
- [textStyleId](McDbBlockReference.md#textstyleid)
- [trueColor](McDbBlockReference.md#truecolor)
- [visible](McDbBlockReference.md#visible)

### Methods

- [IntersectWith](McDbBlockReference.md#intersectwith)
- [appendAttribute](McDbBlockReference.md#appendattribute)
- [clone](McDbBlockReference.md#clone)
- [createAttribute](McDbBlockReference.md#createattribute)
- [deleteXData](McDbBlockReference.md#deletexdata)
- [disableDisplay](McDbBlockReference.md#disabledisplay)
- [erase](McDbBlockReference.md#erase)
- [explode](McDbBlockReference.md#explode)
- [getAllAppName](McDbBlockReference.md#getallappname)
- [getAllAttribute](McDbBlockReference.md#getallattribute)
- [getArea](McDbBlockReference.md#getarea)
- [getBoundingBox](McDbBlockReference.md#getboundingbox)
- [getDatabase](McDbBlockReference.md#getdatabase)
- [getHandle](McDbBlockReference.md#gethandle)
- [getImp](McDbBlockReference.md#getimp)
- [getJson](McDbBlockReference.md#getjson)
- [getObjectID](McDbBlockReference.md#getobjectid)
- [getOwnerID](McDbBlockReference.md#getownerid)
- [getScale](McDbBlockReference.md#getscale)
- [getxData](McDbBlockReference.md#getxdata)
- [getxDataDouble](McDbBlockReference.md#getxdatadouble)
- [getxDataLong](McDbBlockReference.md#getxdatalong)
- [getxDataPoint](McDbBlockReference.md#getxdatapoint)
- [getxDataString](McDbBlockReference.md#getxdatastring)
- [highlight](McDbBlockReference.md#highlight)
- [initTempObject](McDbBlockReference.md#inittempobject)
- [isErased](McDbBlockReference.md#iserased)
- [isKindOf](McDbBlockReference.md#iskindof)
- [isNull](McDbBlockReference.md#isnull)
- [mirror](McDbBlockReference.md#mirror)
- [move](McDbBlockReference.md#move)
- [rotate](McDbBlockReference.md#rotate)
- [scaleEntity](McDbBlockReference.md#scaleentity)
- [setJson](McDbBlockReference.md#setjson)
- [setScale](McDbBlockReference.md#setscale)
- [setxData](McDbBlockReference.md#setxdata)
- [setxDataDouble](McDbBlockReference.md#setxdatadouble)
- [setxDataLong](McDbBlockReference.md#setxdatalong)
- [setxDataPoint](McDbBlockReference.md#setxdatapoint)
- [setxDataString](McDbBlockReference.md#setxdatastring)
- [transformBy](McDbBlockReference.md#transformby)
- [unErase](McDbBlockReference.md#unerase)
...
• `get` **blockTransform**(): [`McGeMatrix3d`](McGeMatrix3d.md)
...
• `get` **scaleFactors**(): [`McGePoint3d`](McGePoint3d.md)
...
▸ **appendAttribute**(`attrib`): [`McObjectId`](McObjectId.md)
...
| Name | Type |
| :------ | :------ |
| `attrib` | [`McDbAttribute`](McDbAttribute.md) |
...
▸ **getAllAttribute**(): [`McObjectId`](McObjectId.md)[]
