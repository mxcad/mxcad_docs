...
`),s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"}")])])])],-1);function A(C,d,u,f,m,h){const p=n("demo"),t=n("clientOnly");return c(),r("div",null,[D,o(t,null,{default:a(()=>[o(p,{"initial-value":`import { McDbCustomEntity, McDbLine, McGePoint3d, McGePoint3dArray, MxCADUiPrPoint, McObject } from "mxcad";
...
`,direction:"",lang:"tsx",height:"undefined"},{default:a(()=>[i]),_:1})]),_:1})])}const w=e(y,[["render",A]]);export{g as __pageData,w as default};
