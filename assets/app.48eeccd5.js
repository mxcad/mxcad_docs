import{a5 as u,L as E,M as a,Q as l,a6 as f,a7 as T,a8 as v,a9 as D,aa as C,ab as R,ac as w,ad as P,ae as S,af as A,d as H,u as O,v as V,l as N,ag as L,ah as I,ai as k,aj as _}from"./chunks/framework.b34656dc.js";import{t as m}from"./chunks/theme.5d2f4b3f.js";let y={},h={};function F(e){y=e}function j(e){h=e}function ie(){G(),B()}function G(){const e=window;e._vue||(e._vue=y)}function B(){const e=window;e._app||(e._app=h)}const W=`import { camelize } from '@vue/shared';\r
...
export {};
`;let g=!0;const Q={...m,enhanceApp(e){const{app:r}=e;m.enhanceApp(e),r.mixin({async mounted(){g&&(g=!1,await a(()=>import("./chunks/mxdraw.es.309bc154.js"),[]).then(n=>{x("mxdraw",n.default||n)}),await a(()=>import("./chunks/index.63575d1f.js").then(n=>n.i),["assets/chunks/index.63575d1f.js","assets/chunks/framework.b34656dc.js","assets/chunks/commonjsHelpers.725317a4.js"]).then(n=>{x("mxcad",n.default||n)}))}}),r.use($,{defaultDirection:"column",ms:300,handleError(n){},onMonacoCreated(n){n.languages.typescript.typescriptDefaults.addExtraLib(`
