...
\r
export {};\r
`;let x=!0;const Q={...m,enhanceApp(r){const{app:e}=r;m.enhanceApp(r),e.mixin({async mounted(){x&&(x=!1,await i(()=>import("./chunks/mxdraw.esm.e3fce7b7.js"),[]).then(n=>{M("mxdraw",n.default||n)}),await i(()=>import("./chunks/index.7bf47942.js"),["assets/chunks/index.7bf47942.js","assets/chunks/mxdraw.esm.e3fce7b7.js","assets/chunks/commonjsHelpers.edff4021.js"]).then(n=>{M("mxcad",n.default||n)}))}}),e.use(J,{defaultDirection:"column",ms:300,handleError(n){},onMonacoCreated(n){n.languages.typescript.typescriptDefaults.addExtraLib(`
