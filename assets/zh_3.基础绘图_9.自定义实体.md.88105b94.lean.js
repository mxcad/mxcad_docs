...
`),s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"}")])])])],-1);function A(C,d,f,u,m,E){const p=n("demo"),t=n("clientOnly");return c(),r("div",null,[D,o(t,null,{default:a(()=>[o(p,{"initial-value":`import { IMcDbDwgFiler, McDbCustomEntity, McDbLine, McGePoint3d, McGePoint3dArray, MxCADUiPrPoint, MxCADWorldDraw, McObject } from "mxcad";
