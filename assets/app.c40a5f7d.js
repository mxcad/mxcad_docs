import{ac as u,ad as E,ae as i,a0 as l,af as f,ag as T,ah as v,ai as D,aj as C,ak as R,al as w,am as P,an as S,ao as A,d as H,u as O,p as V,k as N,ap as L,aq as I,ar as k,O as _}from"./chunks/framework.42a71e76.js";import{t as m}from"./chunks/theme.70a6f655.js";let y={},h={};function F(e){y=e}function j(e){h=e}function ae(){G(),B()}function G(){const e=window;e._vue||(e._vue=y)}function B(){const e=window;e._app||(e._app=h)}const W=`import { camelize } from '@vue/shared';\r
...
export {};
`;let g=!0;const Q={...m,enhanceApp(e){const{app:r}=e;m.enhanceApp(e),r.mixin({async mounted(){g&&(g=!1,await i(()=>import("./chunks/mxdraw.es.309bc154.js"),[]).then(n=>{x("mxdraw",n.default||n)}),await i(()=>import("./chunks/index.22c69d4d.js"),["assets/chunks/index.22c69d4d.js","assets/chunks/framework.42a71e76.js","assets/chunks/commonjsHelpers.725317a4.js"]).then(n=>{x("mxcad",n.default||n)}))}}),r.use($,{defaultDirection:"column",ms:300,handleError(n){},onMonacoCreated(n){n.languages.typescript.typescriptDefaults.addExtraLib(`
